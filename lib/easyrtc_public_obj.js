...
pub.app = function(appName, callback) {
    ...
    /**
     * Returns an array of all usernames connected to the application
     *
     * @memberof    pub.appObj
     * @param       {function(?Error, Array.<string>)} callback Callback with error and array of usernames
     */
     appObj.getConnectionUsernames = function(callback) {
        var usernames = [];
        for (var key in e.app[appName].connection) {
            usernames.push( e.app[appName].connection[key].username);
        }
